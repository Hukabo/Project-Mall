...
export default function ResponsiveSidebar({
  ...
  return (
    <>
      ...
      <aside
        aria-label="상품 카테고리"
        className={`fixed inset-y-0 left-0 z-50 w-[min(82vw,15rem)] bg-surface shadow-2xl transition-transform duration-300 ease-out min-[1260px]:relative min-[1260px]:z-20 min-[1260px]:w-auto min-[1260px]:translate-x-0 min-[1260px]:shadow-none ${
